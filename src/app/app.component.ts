...
import { personCircleOutline, personOutline, chevronForwardCircle, arrowUpCircle, images, camera, chevronForwardOutline, trash, accessibility, peopleOutline, closeOutline, arrowBackOutline, helpCircleOutline, documentText, pencilSharp, ellipseOutline, logoGoogle, accessibilitySharp, logInSharp, logInOutline, mailOutline, mailSharp, paperPlaneOutline, paperPlaneSharp, heartOutline, heartSharp, archiveOutline, archiveSharp, trashOutline, trashSharp, warningOutline, warningSharp, bookmarkOutline, bookmarkSharp, checkboxOutline } from 'ionicons/icons';
